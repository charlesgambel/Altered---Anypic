...
@property (nonatomic, strong) PAPEditPhotoViewController *test;
@end
...
{
    NSLog(@"hellp");
    PAPEditPhotoViewController *view = [[PAPEditPhotoViewController alloc]initWithImage:image];
    [imagePicker.imagePickerController dismissViewControllerAnimated:YES completion:NULL];
}
...
- (BOOL)shouldStartCameraController {
    ...
    self.imagePicker.cropSize = CGSizeMake(310, 400);
