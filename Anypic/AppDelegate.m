...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // [Parse setApplicationId:@"Zf91medWKuqxWbOiydRo9EH4mE4vwfEj38H9sOPG" clientKey:@"CamyCZj9IYteOJNB6Ertkzu00Hm9thADqPU7nVyK"];
    //
    // Make sure to update your URL scheme to match this facebook id. It should be "fb338200936291443" where FACEBOOK_APP_ID is your Facebook app's id.
    ...
    [PFFacebookUtils initializeWithApplicationId:@"338200936291443"];
